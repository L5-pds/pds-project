...
// Begin variable declaration
    ...
    public LineChart(Calcul tmp, String applicationTitle, String chartTitle, String data[][]) {
        this.theCalc = tmp;
        this.data = data;
        JFreeChart lineChart = ChartFactory.createLineChart(chartTitle, "Mois", "Montant restant à payer", createDataset(), PlotOrientation.VERTICAL, true, true, false);
