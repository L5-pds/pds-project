		...
		case "AUTOMOBILE" :
			...
			if (Integer.parseInt(duration.getText()) < 36){
				if ((Integer.parseInt(amount.getText()) >= 3000) && (Integer.parseInt(amount.getText())<15000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type du pr�t 1-1") ;
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 3000) && (Integer.parseInt(amount.getText())<15000)){
					...
					System.out.println(("Le montant n'est pas d�fini pour ce type de pr�t 1-2"));
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 3000) && (Integer.parseInt(amount.getText())<15000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type de pr�t 1-3");
				}
		...
		case "IMMOBILIER" :
			...
			if ((Integer.parseInt(duration.getText()) >= 60) && (Integer.parseInt(duration.getText()) <180)){
				if ((Integer.parseInt(amount.getText()) >= 50000) && (Integer.parseInt(amount.getText()) < 250000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type du pr�t 2-1") ;
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 50000) && (Integer.parseInt(amount.getText()) < 250000)){
					...
					System.out.println(("Le montant n'est pas d�fini pour ce type de pr�t 2-2"));
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 50000) && (Integer.parseInt(amount.getText()) < 250000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type de pr�t 2-3");
				}
		...
		case "DIVERS" :
			...
			if ((Integer.parseInt(duration.getText()) >= 3) && (Integer.parseInt(duration.getText()) <24)){
				if ((Integer.parseInt(amount.getText()) >= 200) && (Integer.parseInt(amount.getText()) < 20000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type du pr�t 3-1") ;
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 200) && (Integer.parseInt(amount.getText()) < 20000)){
					...
					System.out.println(("Le montant n'est pas d�fini pour ce type de pr�t 3-2"));
				}
			}
				...
				if ((Integer.parseInt(amount.getText()) >= 200) && (Integer.parseInt(amount.getText()) < 20000)){
					...
					System.out.println("Le montant n'est pas d�fini pour ce type de pr�t 3-3");
				}
